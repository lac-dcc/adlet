...
int main() {
  ...
  auto O1 = std::make_shared<Tensor>(8, 4, 0.0, 0.0, "O1");
  auto W2 = std::make_shared<Tensor>(4, 4, 0.0, 0.0, "W2");
  auto O2 = std::make_shared<Tensor>(8, 4, 0.0, 0.0, "O2");
  auto Y = std::make_shared<Tensor>(8, 4, 0.0, 0.0, "Y");
  auto Y_T = std::make_shared<Tensor>(4, 8, 0.0, 0.0, "Y_T");
